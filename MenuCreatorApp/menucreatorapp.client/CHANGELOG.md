...
- Create Angular project with ng: `ng new menucreatorapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`menucreatorapp.client.esproj`).
